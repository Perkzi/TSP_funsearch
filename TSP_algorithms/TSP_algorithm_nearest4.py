...
def tsp_priority(
    ...
    # Compute the candidate's minimum distance to any visited city
    ...
    # Determine the best insertion index using the extra cost calculation (as in the cheapest insertion strategy)
    n = len(current_tour)
    if n < 2:
    ...
    priority = -min_distance  # For nearest insertion, a candidate closer to the tour (smaller distance) is preferred.
